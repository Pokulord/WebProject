...
function Card({ id, img, author, name, slug, discount, final_price, orig_price, imgSize = 'md', how_many, forsell, token }) {
    console.log('GOT')
    if (!name) {
        return (
        ...
        <>
            ...
            <div className={style.card}>
                ...
                <div className={style.content}>
                    ...
                    <Link className={style.title} to={`/gallery/${slug}/`}>{name}</Link>
